...
module("integration/embedded_records2_mixin - EmbeddedRecords2Mixin", {
  setup: function() {
    ...
    env.registry.register('serializer:application', DS.REST2Serializer.extend(DS.EmbeddedRecords2Mixin));
    //env.registry.register('serializer:-rest2', DS.REST2Serializer.extend(DS.EmbeddedRecords2Mixin));
    //env.rest2Serializer = env.container.lookup("serializer:-rest2");
    //env.restAdapter    = env.container.lookup("adapter:-rest");
  },
...
test("extractSingle with embedded objects", function() {
  ...
  env.registry.register('serializer:home-planet', DS.REST2Serializer.extend(DS.EmbeddedRecords2Mixin, {
    attrs: {
  ...
  run(function() {
    json = serializer.normalizeResponse(env.store, HomePlanet, json_hash, '1', 'find');
  });
...
test("extractSingle with embedded objects inside embedded objects", function() {
  ...
  env.registry.register('serializer:super-villain', DS.REST2Serializer.extend(DS.EmbeddedRecords2Mixin, {
    attrs: {
      evilMinions: { embedded: 'always' }
    }
  }));
  env.registry.register('serializer:evil-minion', DS.REST2Serializer);
...
test("extractSingle with embedded objects of same type", function() {
  ...
  env.registry.register('serializer:comment', DS.REST2Serializer.extend(DS.EmbeddedRecords2Mixin, {
    attrs: {
  ...
  var json;
  run(function() {
    json = serializer.normalizeResponse(env.store, Comment, json_hash, '1', 'find');
  });
...
test("extractSingle with embedded objects of same type, but from separate attributes", function() {
  ...
  env.registry.register('serializer:super-villain', DS.REST2Serializer);
...
test("extractSingle with embedded object (belongsTo relationship)", function() {
  ...
  //env.registry.register('serializer:secret-lab', DS.REST2Serializer);
  ...
  run(function() {
    json = serializer.normalizeResponse(env.store, SuperVillain, json_hash, '1', 'find');
  });
...
test("serialize with embedded object (belongsTo relationship) works with different primaryKeys", function() {
  ...
  env.registry.register('serializer:secret-lab', DS.REST2Serializer.extend(DS.EmbeddedRecords2Mixin, {
    primaryKey: 'crazy_id'
  }));
...
test("extractSingle with multiply-nested belongsTo", function() {
  ...
  env.registry.register('serializer:evil-minion', DS.REST2Serializer.extend(DS.EmbeddedRecords2Mixin, {
    attrs: {
...
test("Mixin can be used with RESTSerializer which does not define keyForAttribute", function() {
  ...
  env.registry.register('serializer:super-villain', DS.RESTSerializer.extend(DS.EmbeddedRecords2Mixin, {
    attrs: {
      evilMinions: { serialize: 'records', deserialize: 'records' }
    }
  }));
...
test("serializing relationships with an embedded and without calls super when not attr not present", function() {
  ...
  env.registry.register('serializer:super-villain', Serializer.extend(DS.EmbeddedRecords2Mixin, {
    attrs: {
      evilMinions: { serialize: 'records', deserialize: 'records' }
